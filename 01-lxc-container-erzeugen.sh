...
pct exec 999 -- bash -c "apt install git && git clone https://github.com/MichaelsIT1/ERP-opensource-Box.git && /root/ERP-opensource-Box/install-xentral-opensource.sh"
